                          ...
                          Real dt, int rk)
{
    ...
    amrex::ParallelFor(bxg7,
        ...
        {
            AMREX_D_TERM(
            utr[0](i,j,k,URHOY) = amrex::max(Real(0.0),amrex::min(utr[0](i,j,k,URHOY),utr[0](i,j,k,URHO)));,
            utr[1](i,j,k,URHOY) = amrex::max(Real(0.0),amrex::min(utr[1](i,j,k,URHOY),utr[1](i,j,k,URHO)));,
            utr[2](i,j,k,URHOY) = amrex::max(Real(0.0),amrex::min(utr[2](i,j,k,URHOY),utr[2](i,j,k,URHO)));
            );

            AMREX_D_TERM(
            udi[0](i,j,k,URHOY) = amrex::max(Real(0.0),amrex::min(udi[0](i,j,k,URHOY),udi[0](i,j,k,URHO)));,
            udi[1](i,j,k,URHOY) = amrex::max(Real(0.0),amrex::min(udi[1](i,j,k,URHOY),udi[1](i,j,k,URHO)));,
            udi[2](i,j,k,URHOY) = amrex::max(Real(0.0),amrex::min(udi[2](i,j,k,URHOY),udi[2](i,j,k,URHO)));
            );

            udfab(i,j,k,URHOY)  = amrex::max(0.0,amrex::min(udfab(i,j,k,URHOY),udfab(i,j,k,URHO)));   
        });
    }
