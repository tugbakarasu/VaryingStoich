                          ...
                          Real dt, int rk)
{
    ...
    amrex::ParallelFor(bxg7,
        [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
        {
            ...
            AMREX_D_TERM(
            utr[0](i,j,k,URHOY_F) = amrex::max(Real(0.0), amrex::min(utr[0](i,j,k,URHOY_F), utr[0](i,j,k,URHO)));,
            utr[1](i,j,k,URHOY_F) = amrex::max(Real(0.0), amrex::min(utr[1](i,j,k,URHOY_F), utr[1](i,j,k,URHO)));,
            utr[2](i,j,k,URHOY_F) = amrex::max(Real(0.0), amrex::min(utr[2](i,j,k,URHOY_F), utr[2](i,j,k,URHO)));
            );

            AMREX_D_TERM(
            utr[0](i,j,k,URHOY_O) = amrex::max(Real(0.0), amrex::min(utr[0](i,j,k,URHOY_O), utr[0](i,j,k,URHO)));,
            utr[1](i,j,k,URHOY_O) = amrex::max(Real(0.0), amrex::min(utr[1](i,j,k,URHOY_O), utr[1](i,j,k,URHO)));,
            utr[2](i,j,k,URHOY_O) = amrex::max(Real(0.0), amrex::min(utr[2](i,j,k,URHOY_O), utr[2](i,j,k,URHO)));
            );

          
            AMREX_D_TERM(
            utr[0](i,j,k,URHOY_P) = amrex::max(Real(0.0), amrex::min(utr[0](i,j,k,URHOY_P), utr[0](i,j,k,URHO)));,
            utr[1](i,j,k,URHOY_P) = amrex::max(Real(0.0), amrex::min(utr[1](i,j,k,URHOY_P), utr[1](i,j,k,URHO)));,
            utr[2](i,j,k,URHOY_P) = amrex::max(Real(0.0), amrex::min(utr[2](i,j,k,URHOY_P), utr[2](i,j,k,URHO)));
            );

            AMREX_D_TERM(
            udi[0](i,j,k,URHOY_F) = amrex::max(Real(0.0), amrex::min(udi[0](i,j,k,URHOY_F), udi[0](i,j,k,URHO)));,
            udi[1](i,j,k,URHOY_F) = amrex::max(Real(0.0), amrex::min(udi[1](i,j,k,URHOY_F), udi[1](i,j,k,URHO)));,
            udi[2](i,j,k,URHOY_F) = amrex::max(Real(0.0), amrex::min(udi[2](i,j,k,URHOY_F), udi[2](i,j,k,URHO)));
            );

	    AMREX_D_TERM(
            udi[0](i,j,k,URHOY_O) = amrex::max(Real(0.0), amrex::min(udi[0](i,j,k,URHOY_O), udi[0](i,j,k,URHO)));,
            udi[1](i,j,k,URHOY_O) = amrex::max(Real(0.0), amrex::min(udi[1](i,j,k,URHOY_O), udi[1](i,j,k,URHO)));,
            udi[2](i,j,k,URHOY_O) = amrex::max(Real(0.0), amrex::min(udi[2](i,j,k,URHOY_O), udi[2](i,j,k,URHO)));
            );

            AMREX_D_TERM(
            udi[0](i,j,k,URHOY_P) = amrex::max(Real(0.0), amrex::min(udi[0](i,j,k,URHOY_P), udi[0](i,j,k,URHO)));,
            udi[1](i,j,k,URHOY_P) = amrex::max(Real(0.0), amrex::min(udi[1](i,j,k,URHOY_P), udi[1](i,j,k,URHO)));,
            udi[2](i,j,k,URHOY_P) = amrex::max(Real(0.0), amrex::min(udi[2](i,j,k,URHOY_P), udi[2](i,j,k,URHO)));
            );
